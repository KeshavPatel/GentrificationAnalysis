%% PDE Toolbox Implementation for PDE System - Changing Geometry
%{
...
file for each set of variables. This file is a modified version of
"continuumSimulation.m" to account for the changing geometry scheme.
%}

function [ result ,model,dimensions, oldResult] = continuumSimulationGeometry(R,E,B, dt,timeSteps,S,A,initialCondition)
